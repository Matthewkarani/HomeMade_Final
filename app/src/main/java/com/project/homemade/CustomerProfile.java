...
public class CustomerProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profUserName = findViewById(R.id.username);
        imageButton = findViewById(R.id.imgbtn1);
        doneBtn = findViewById(R.id.buttonNext1);
        ...
        mDatabaseUser = FirebaseDatabase.getInstance().getReference().child("Users").child("Customers").child(userID);
        ...
        doneBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(name) && profileImageUri != null) {
                    ...
                    StorageReference profileImagePath = mStorageRef.child("customer_profile_images").child(profileImageUri.getLastPathSegment());
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            mDatabaseUser.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    mDatabaseUser.child(" Customer Username").setValue(name);
                                                    mDatabaseUser.child("profilePhoto").setValue(profileImage).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                Intent login = new Intent(CustomerProfile.this, MapsActivity.class);
                                                                startActivity(login);
                                                            }
                                                        }
                                                    });
    ...
    public void Send_to_map(View view) {
        Intent login = new Intent( CustomerProfile.this, MapsActivity.class);
        startActivity(login);
    }
}
